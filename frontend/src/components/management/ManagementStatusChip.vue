...
const chipClass = computed(() => {
  const map = {
    Pending_Organizer: 'bg-cyan-50 text-cyan-800 ring-1 ring-cyan-200/80',
    ...
    Pending_Boss: 'bg-cyan-50 text-cyan-800 ring-1 ring-cyan-200/80',
  };
