...
export const PUBLIC_LINKS = [
  { labelKey: 'navigation.community', to: '/community', exact: true },
  { labelKey: 'navigation.carbootPreview', to: '/marketplace', exact: true },
  { labelKey: 'navigation.events', to: '/calendar' },
  { labelKey: 'navigation.becomeVendor', to: '/community', hash: '#become-vendor', testId: 'nav-become-vendor' },
];

/** Authenticated community visitors — always-visible top-level links */
export const COMMUNITY_PRIMARY_LINKS = [
  { labelKey: 'navigation.community', to: '/community', exact: true, testId: 'nav-community' },
  { labelKey: 'navigation.myReservations', to: '/community', hash: '#my-item-reservations', testId: 'nav-my-reservations' },
];
...
export const COMMUNITY_EXPLORE_MENU = {
  ...
  items: [
    { labelKey: 'navigation.carbootPreview', to: '/marketplace', exact: true, testId: 'nav-carboot-preview' },
    { labelKey: 'navigation.events', to: '/calendar', testId: 'nav-events' },
  ],
};
...
export const VENDOR_MANAGE_MENU = {
  ...
  items: [
    { labelKey: 'navigation.myBookings', to: '/vendor/manage/bookings', testId: 'nav-manage-bookings' },
    { labelKey: 'navigation.eventPasses', to: '/vendor/manage/event-passes', testId: 'nav-manage-event-passes' },
    { labelKey: 'navigation.myItems', to: '/vendor/manage/items', testId: 'nav-manage-items' },
    {
...
export const VENDOR_EXPLORE_MENU = {
  ...
  items: [
    ...
    { labelKey: 'navigation.community', to: '/community', exact: true, testId: 'nav-community' },
    { labelKey: 'navigation.events', to: '/calendar', testId: 'nav-events' },
    { labelKey: 'navigation.myReservations', to: '/my-reservations', testId: 'nav-my-reservations' },
  ],
};
...
export const VENDOR_ACCOUNT_MENU = {
  ...
  testId: 'nav-account-menu',
  items: [
    { labelKey: 'navigation.businessProfile', to: '/profile', testId: 'nav-business-profile' },
    { labelKey: 'navigation.paymentHistory', to: '/vendor/payment-history', testId: 'nav-payment-history' },
    { labelKey: 'navigation.insights', to: '/vendor/insights', testId: 'nav-insights' },
  ],
};
