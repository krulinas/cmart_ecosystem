...
| Item reservation and extra charge | Resolved | Phase 4.5 | Phase 4 browser E2E, fixture isolation, and closure gates are complete | none to Phase 3 closure | Phase 4.5 complete | see `docs/phase-4/phase-4-5-e2e-hardening-and-closure.md` |
