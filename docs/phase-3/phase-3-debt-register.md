...
| Item reservation and extra charge | In progress | Phase 4 | Phase 4.4 completion workflow and role-safe reservation UIs are complete; browser E2E and final hardening remain deferred to Phase 4.5 | no risk to Phase 3 closure | Phase 4.4 complete | Phase 4.5 E2E, hardening, and closure acceptance criteria |
